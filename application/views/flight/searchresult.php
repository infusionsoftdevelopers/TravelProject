            ...
            <div class="row">
                <aside class="col-md-3 col-sm-4 col-xs-12 content-aside left_column sidebar-offcanvas">
                    ...
                    <div class="module-search clearfix">
                        <h3 class="modtitle text-white">Change Search</h3>
                        <form class="searchform" action="<?php echo base_url('flight/results') ;?>" method="get">
                            <input type="hidden" name="direct_flights" value="No">
                            <div class="row">
                                <div class="col-lg-12">
                                    <label class="text-white fs-16" for="flight_type1"><input class="flighttype" value="Return" type="radio" name="flight_type" id="flight_type1" <?php echo($flight_type == 'Return')?'checked':''; ?>> Return</label>
                                    <label class="text-white fs-16" for="flight_type2"><input class="flighttype" value="Oneway" type="radio" name="flight_type" id="flight_type2" <?php echo($flight_type == 'Oneway')?'checked':''; ?>> One-way</label>
                                </div>
                                <div class="col-xs-12">
                                    <div class="form-group mb-5">
                                        <label class="text-white mb-0"><strong>Flying From</strong></label>
                                        <div class="input-group">
                                            <input type="text" name="dept_arpt" class="form-control arpt" placeholder="Enter Departure Airport..." required  value="<?php echo $departure_airport ; ?>">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group mb-5">
                                        <label class="text-white mb-0"><strong>Flying to</strong></label>
                                        <div class="input-group">
                                            <input type="text" name="dest_arpt" class="form-control arpt" placeholder="Enter Destination Airport..." required value="<?php echo $destination_airport ; ?>">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group mb-5">
                                        <label class="text-white mb-0"><strong>Departure Date</strong></label>
                                        <div class="input-group">
                                            <input type="text" name="departure_date" class="form-control departure_date" placeholder="Enter Departure Date..." required  value="<?php echo $departure_date ; ?>">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 return-date-selection">
                                    <div class="form-group mb-5">
                                        <label class="text-white mb-0"><strong>Return Date</strong></label>
                                        <div class="input-group">
                                            <input type="text" name="return_date" class="form-control return_date" placeholder="Enter Return Date..." required value="<?php echo $return_date ; ?>">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-xs-6">
                                    <div class="form-group mb-5">
                                        <label class="text-white mb-0"><strong>Cabin Class</strong></label>
                                        <div class="input-group">
                                            ...
                                            <option value="Economy"  <?php echo($cabin_class == 'Economy')?'selected':''; ?>>Economy</option>
												<option value="Premium Economy" <?php echo($cabin_class == 'Premium Economy')?'selected':''; ?>>Premium</option>
												<option value="Business Class" <?php echo($cabin_class == 'Business Class')?'selected':''; ?>>Business</option>
												<option value="First Class" <?php echo($cabin_class == 'First Class')?'selected':''; ?>>First Class</option>
                                            </select>
                                ...
                                <div class="col-lg-6 col-xs-6">
                                    <div class="form-group mb-5">
                                        <label class="text-white mb-0"><strong>Airlines</strong></label>
                                        <div class="input-group">
                                            <select class="form-control" name="airline" required>
                                                <<option selected>All Airlines</option>
												<?php if($airline =='' || $airline =='All Airlines' ){
													foreach ($repeatcheckarray as $value) {
												?>
												<option value="<?php echo $arrairline["$value"]; ?> - <?php echo $value; ?>">
													<?php echo $arrairline["$value"]; ?> - <?php echo $value; ?>
												</option>
												<?php
													}}
												?>
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <div class="form-group mb-5">
                                                <label class="text-white mb-0"><strong>Adults</strong></label>
                                                <select class="form-control" name="padults" required>
                                                    <?php
                                                    $opt =  10;
                                                    for ($i = 1; $i <= $opt; $i++) {
                                                    ?>
                                                        <option value="<?php echo $i; ?>" <?php echo($padults == $i)?'selected':''; ?>><?php echo $i; ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-xs-4">
                                            <div class="form-group mb-5">
                                                <label class="text-white mb-0"><strong>Kids</strong></label>
                                                <select class="form-control" name="pchildren">
                                                    <?php
                                                    $opt =  10;
                                                    for ($i = 0; $i <= $opt; $i++) {
                                                    ?>
                                                        <option value="<?php echo $i; ?>" <?php echo($pchildren == $i)?'selected':''; ?>><?php echo $i; ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-xs-4">
                                            <div class="form-group mb-5">
                                                <label class="text-white mb-0"><strong>Infants</strong></label>
                                                <select class="form-control" name="pinfants">
                                                    <?php
                                                    $opt =  10;
                                                    for ($i = 0; $i <= $opt; $i++) {
                                                    ?>
                                                        <option value="<?php echo $i; ?>" <?php echo($pinfants == $i)?'selected':''; ?>><?php echo $i; ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                            ...
                            <div class="row">
                                <div class="col-lg-12 mt-20">
                                    <button type="submit" class="btn btn-primary btn-search form-control"><i class="fa fa-search"></i>Search Now</button>
                                </div>
                            </div>
                        </form>				
                    </div>
                    ...
                    <div class="module-travel clearfix">
                        ...
                        <ul>
                            ...
                            ?>
                            <li><a href="javascript:void(0);"><span>Fly From <?php echo $deptrow['f_from']; ?></span><label>fr £ <?php echo $deptrow['price']; ?></label></a></li>
                            <?php } ?>
                        </ul>
                    </div>
                    ...
                    <div class="module-travel clearfix">
                        ...
                        <ul>
                            ...
                            ?>
                            <li><a href="<?php echo base_url('fly-to-'.str_replace(" ","-",$otherrow['f_to'])); ?>"><span>Flights To <?php echo $otherrow['f_to']; ?></span><label>fr £ <?php echo $otherrow['price']; ?></label></a></li>
						    <?php } ?>
                        </ul>
                    </div>
                    <?php } ?>
                ...
                <div id="content" class="col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="products-category">
                        <div class="section-style4 products-list list row number-col-3 so-filter-gird">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 pricedetail">
                                        <div class="item-inner text-center">
                                            <h4 style="line-height: 40px;margin-bottom: 5px;"><small>Starting From</small><br><strong style="font-size:40px;">£ <?php echo $adultprice; ?></strong><small> PP</small></h4>
                                            <a class="btn btn-primary btn-sm btn-danger" href="javascript: bookingRequest([<?php echo "'$outdeptdate', '$outdepttime', '" . $arrport["$fltdeparture"] . "', '$outarvdate', '$outarvtime', '" . $arrport["$fltdestination"] . "', '$odur', '$onostops', '$indeptdate', '$indepttime', '" . $arrport["$fltdestination"] . "', '$inarvdate', '$inarrvtime', '" . $arrport["$fltdeparture"] . "', '$idur', '$inostops', '$departure_airport', '$destination_airport', '$fltairline', '" . $arrairline["$fltairline"] . "', '$padults', '$pchildren', '$pinfants', '$adultprice', '$ttlprice'"; ?>]);"><i class="fa fa-check"></i><strong>Book Now</strong></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
